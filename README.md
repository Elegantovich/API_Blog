...
- настроена система пермишенов, которая позволит только автору блога изменять его и посты, а пользоваться приложением могут только автризированные пользователи
